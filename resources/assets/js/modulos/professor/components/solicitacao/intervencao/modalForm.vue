<template>
    <el-dialog :title="edit == true ? $t('message.edit', {msg:  'Intervenção'}) : $t('message.add', {msg:  'Intervenção'})" :visible.sync="dialogVisible" width="70%"
                ...
                <el-form ref="form" :model="form" :rules="rules" label-position="top" class="demo-ruleForm" @submit.native.prevent="submitForm('form')" id="formUsuarios">
                    <div class="row">
                        ...
                        <el-form-item label="Data" class="col-sm-12 col-md-6"
                            ...
                            <el-date-picker v-model="form.cad_data" type="datetime" format="dd/MM/yyyy" value-format="yyyy-MM-dd" v-mask="'##/##/#### ##:##:##'" clearable>
                            </el-date-picker>
                        </el-form-item>
                        ...
                        <el-form-item label="Motivo" class="col-sm-12 col-md-12" size="mini" prop="cad_motivo">
                            <el-input type="textarea" v-model="form.cad_motivo">
                            </el-input>
                        </el-form-item>
                    </div>
                </el-form>
