    ...
    <div>
        <div class="content-header" style="padding-bottom: 0px">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0">Ficha Anamnese</h1>
                    </div>
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active">Ficha Anamnese</li>
                        </ol>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <el-table :data="defeitos" style="width: 100%" tooltip-effect="dark" stripe>
                            <el-table-column prop="id_defeito" label="Id" width="120px" show-overflow-tooltip>
                            </el-table-column>

                            <el-table-column prop="dsc_defeito" label="Nome" show-overflow-tooltip width="400px">
                            </el-table-column>
                            ...
                            <el-table-column label="Funções" align="center">
                                <template slot-scope="scope">
                                    ...
                                    <a href="#" class="edit" @click.prevent="editar(scope.row.id_defeito)"
                                        title="Editar"><i class="fas fa-edit fa-lg" style="color:#0085fa;"></i></a>

                                    <!-- v-if="can($route.name, 3)" -->
                                    <a href="#" @click.prevent="open(scope.row.id_defeito)" title="Excluir"><i
                                            class="fas fa-trash-alt fa-lg" style="color:#f00;"></i></a>
                                </template>
                            </el-table-column>
                        </el-table>
                    </div>
